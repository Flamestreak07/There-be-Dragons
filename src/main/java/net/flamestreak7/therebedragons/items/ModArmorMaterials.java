...
public enum ModArmorMaterials implements ArmorMaterial {
    ...
    private static int[] BASEDURABILITY = {11, 16, 15, 13};

    ModArmorMaterials(String name, int durabilityMult, int[] protectionAmounts, int enchantability, SoundEvent equipSound,
    ...
    public int getDurability(ArmorItem.Type type) {
        return BASEDURABILITY[type.ordinal()] * this.durabilityMult;
    }
    ...
    public String getName() {
        return ThereBeDragons.MOD_ID + ":" + this.name;
    }
